...
public class TraffickingSim extends GGApplication{
    ...
    public void setup() {
       ...
       Text text = new Text("", new Vector2f(), 0.8f, 0.4f, false);
       
       GUI.addItem("totviolence", new GUIText(text.copyFormat("Sonic"), font, new Vector2f(0,0)));
       GUI.addItem("totarms", new GUIText(text.copyFormat("Knuckles"), font, new Vector2f(1f,0)));
       GUI.addItem("totowner", new GUIText(text.copyFormat("Tails"), font, new Vector2f(0f,-0.05f)));
       GUI.addItem("totsurplus", new GUIText(text.copyFormat("Amy"), font, new Vector2f(1,-0.05f)));
       GUI.addItem("totdesire", new GUIText(text.copyFormat("Shadow"), font, new Vector2f(0f,-0.1f)));
       GUI.addItem("totlegal", new GUIText(text.copyFormat("Cream"), font, new Vector2f(1f,-0.1f)));
    }
